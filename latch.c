...
#define API_CHECK_STATUS_URL "/api/1.3/status"
#define API_PAIR_URL "/api/1.3/pair"
#define API_PAIR_WITH_ID_URL "/api/1.3/pairWithId"
#define API_UNPAIR_URL "/api/1.3/unpair"
#define API_LOCK_URL "/api/1.3/lock"
#define API_UNLOCK_URL "/api/1.3/unlock"
#define API_HISTORY_URL "/api/1.3/history"
#define API_OPERATION_URL "/api/1.3/operation"
